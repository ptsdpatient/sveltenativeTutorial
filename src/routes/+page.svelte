...
<p class="md:text-5xl text-3xl px-5 hiddenDiv font-bold md:px-20  md:text-center {themeGradient} bg-clip-text text-transparent  ">Doubting Svelte or this tutorial? </p>
<br>
